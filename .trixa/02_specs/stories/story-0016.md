...
| AC | Test Suite | File |
|---|---|---|
| AC-1 | `Notifications / Generation` | `src/__tests__/notifications.integration.test.tsx` |
| AC-2 | `Notifications / Badge` | `src/__tests__/notifications.integration.test.tsx` |
| AC-3 | `Notifications / ListAndRead` | `src/__tests__/notifications.integration.test.tsx` |
