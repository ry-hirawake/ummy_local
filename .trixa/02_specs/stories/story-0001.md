...
| AC | Test | File |
|---|---|---|
| AC-1 | `test_story_0001_ac1_home_feed_moves_types_and_mock_data_out_of_page` (4 tests) | `__tests__/story-0001.test.tsx` |
| AC-2 | `test_story_0001_ac2_home_feed_renders_mock_posts_in_order` (3 tests) | `__tests__/story-0001.test.tsx` |
| AC-3 | `test_story_0001_ac3_reaction_selection_updates_counts_and_closes_popup` (3 tests) | `__tests__/story-0001.test.tsx` |
| AC-4 | `test_story_0001_ac4_comments_and_reply_input_toggle_per_post_comment` (4 tests) | `__tests__/story-0001.test.tsx` |
| AC-5 | `test_story_0001_ac5_home_feed_uses_next_image_for_all_avatars` (3 tests) | `__tests__/story-0001.test.tsx` |
