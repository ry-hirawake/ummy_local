...
---
- Story-0017: Claude の現在の実装着手対象は `story-0017` のみ。`story-0020` 以降へ進んではならない / owner:claude / since:2026-04-01 / next:`story-0017` を実装し `Implemented` まで進め、Codex レビュー後に次Story着手可否を判断する
